...
layui.define([], function (exports) {
	...
	fsConfig["global"] = {
		...
		"loginUrl" : "/signin.html", //登录url
		"uploadUrl" : "https://api.salon.hfsys.cn/slfile/out/icon", //上传附件url
		...
		"result" : { //响应结果配置
	    "statusName": "errorCode", //数据状态的字段名称，默认：errorNo
	    "msgName": "errorMsg", //状态信息的字段名称，默认：errorInfo
			"successNo" : "0", //执行成功错误码统一配置
	    "dataName" : "data", //非表格数据的字段名称，默认：results.data
			"file" : { //文件配置
	    	"path" : "data.fileId"  //返回文件路径属性
	    }
		},
		"page" : { //分页配置
			...
			"response": {//响应配置
				"countName": "totalSize", //数据总数的字段名称，默认：results.data.total
